<template>
    <div class="container-fluid d-flex justify-content-center">
        ...
        <div v-if="loading_info" class="result_area">
            ...
            <h5 v-if="loading_info" class="pb-4"> Checking if <strong> {{ query }} </strong> exists in our records, using {{ filter }}. </h5>
            <Spinnergrow />
            <div class="text-center pt-5 pb-5">
                <Spinner :size="17" />
            </div>
            <span class="lead d-flex justify-content-center"> Kindly wait, your request may take a while. </span>
